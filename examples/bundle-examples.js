...
React.render(
    React.createElement("div", null, 
            React.createElement("h2", null, "Single item"), 
            React.createElement(Slidable, {className: "slidable--single"}, 
                slides
            ), 

            React.createElement("h2", null, "Multiple Items"), 
            React.createElement("p", {className: "todo"}, "TODO"), 
            /* <Slidable className="slidable--multiple"
                slidesToShow={3} slidesToScroll={3}>
                {slides}
                </Slidable> */

                React.createElement("h2", null, "Autoplay"), 
                React.createElement("p", {className: "todo"}, "TODO"), 
                /* <Slidable className="slidable--autoplay"
                    ...
                    React.createElement("h2", null, "Custom transition"), 
                    React.createElement("p", {className: "todo"}, "TODO"), 
                    /* <Slidable className="slidable--custom-transition">
                        {slides}
                        </Slidable> */

                        React.createElement("h2", null, "Callback subscribtion"), 
                        React.createElement("p", {className: "todo"}, "TODO")
...
},{"../../lib/slidable.js":3,"./slide.jsx":2,"react":166}],2:[function(require,module,exports){
...
var Slide = React.createClass({displayName: "Slide",
    ...
    render: function() {
        var titleElement = (this.props.id && this.props.title &&
                            (
                                React.createElement("h2", {className: "slide__description_title"}, 
                                    this.props.id, ". ", this.props.title
                                )
                            ));

        var textElement = (
            React.createElement("p", {className: "slide__description__text"}, 
              this.props.text
            )
        );

        return (
            React.createElement("div", {className: "slide", style: this.props.style}, 
                React.createElement("div", {className: "slide__description"}, 
                    titleElement, 
                    textElement
                ), 
                React.createElement("div", {className: "slide__image"}, 
...
var Slidable = React.createClass({displayName: "Slidable",
    propTypes: {
    ...
    render: function() {
        ...
        return (
                React.createElement("div", {className: slidableClasses}, 
                    React.createElement("div", {className: "slidable__left"}, 
                        React.createElement("a", {href: "#", onClick: this.handleClickLeft}, "LEFT")
                    ), 
                    React.createElement("div", {className: "slidable__right"}, 
                        React.createElement("a", {href: "#", onClick: this.handleClickRight}, "RIGHT")
                    ), 
                    React.createElement("div", {ref: "wrapper", className: "slidable__slides-wrapper"}, 
                        React.createElement("div", {ref: "track", className: "slidable__slides__track", style: trackStyle}, 
                            slides
                        )
                    )
                )
